...
if (HaxSmokeOn==0) then
{
	...
	sCode = 'while {HaxSmokeOn==1} do {';
	sCode = sCode + 'Flare = "SmokeShell" createVehicle position vehicle player;Flare attachTo [vehicle player,[0,-2,0]];';
	sCode = sCode + 'Flare1 = "SmokeshellRed" createVehicle position vehicle player;Flare1 attachTo [vehicle player,[-2,-2,0]];';
	sCode = sCode + 'Flare2 = "SmokeshellBlue" createVehicle position vehicle player;Flare2 attachTo [vehicle player,[2,-2,0]];';
	sCode = sCode + 'sleep 28;};';
