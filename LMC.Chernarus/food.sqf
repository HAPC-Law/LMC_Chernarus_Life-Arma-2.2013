...
switch _item do 
	...
	case "Cheeseburger":     { _hungerStillen = 60;  };
	
	case "steakfries":     { _hungerStillen = 20;  };
	
	case "Chips":     { _hungerStillen = 10;  };
	
	case "cocacola":     { _hungerStillen = 5;  };
	
	case "Pepsi":     { _hungerStillen = 5;  };
	
	case "Sprite":     { _hungerStillen = 5;  };
	
	case "drpepper":     { _hungerStillen = 5;  };
	
	case "Burrito":     { _hungerStillen = 40;  };
	...
	case "Apfel":     { _hungerStillen = 10;  };
	
	case "Peach":     { _hungerStillen = 15;  };
