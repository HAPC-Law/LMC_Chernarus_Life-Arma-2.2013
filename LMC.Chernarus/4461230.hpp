class MainMenu
{
    ...
    class dummybutton : RscDummy {idc = 1033;};
};
...
class TextEinstellungenDialog
{
    ...
    class dummybutton : RscDummy {idc = 1034;};
};
...
class TutorialDialog
{
    ...
    class dummybutton : RscDummy {idc = 1035;};
};
...
class FAQDialog
{
    ...
    class dummybutton : RscDummy {idc = 1036;};
};
...
class AboutDialog
{
    ...
    class dummybutton : RscDummy {idc = 1037;};
};