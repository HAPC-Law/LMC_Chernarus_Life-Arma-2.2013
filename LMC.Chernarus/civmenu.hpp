class civmenu
{
    ...
    class button_disarm : RscButton
    {
        ...
        w = 0.20;
        h = 0.04;
        text = $STRD_description_civmenu_disarm;
    ...
    class button_drugs : RscButton
    {
        ...
        w = 0.20;
        h = 0.04;
        text = $STRD_description_civmenu_drugs;
    ...
    class button_cuff : RscButton
    {
        ...
        h = 0.04;
        text = "Cuff/Uncuff";
        action = "[] execVM ""stealthstick\cuff.sqf""; closedialog 0";
    };
    ...
    class button_ticket : RscButton
    {
        ...
        w = 0.20;
        h = 0.04;
        text = $STRD_description_civmenu_ticket;
