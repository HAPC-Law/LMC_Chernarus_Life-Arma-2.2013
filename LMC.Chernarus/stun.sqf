private ["_UID","_validUIDList","_ammo","_wep","_bullet","_vel","_pos","_teiler","_shooter","_selection","_damage","_weapons","_art","_stunbullets"];
_art         = _this select 0;
_stunbullets = ["B_12Gauge_74Slug","B_9x19_SD","B_9x18_SD","B_9x39_SP5","B_30mm_AP","B_545x39_SD","B_556x45_SD","B_556x45_Ball_SD","B_30x113mm_M789_HEDP"];
...
if (_art == "fired") then
{
    ...
    if(player distance copbase1 < 200 and iscop and vehicle player == player) exitwith
    {
	_UID = getPlayerUID player;
	if (_UID in CopBaseShoot) exitWith {};
	deletevehicle _bullet;
	if(firestrikescop == 0) exitwith
        {
	...
	firestrikescop = firestrikescop - 1;
	(format['hint "WARNING %1: DO NOT FIRE INSIDE THE COPBASE! %2/%3 chances left.";', name player, firestrikescop, totalstrikescop]) call broadcast;
    };
    if(player distance civspawn < 100 and _wep != "M1014" and _wep != "MakarovSD" and _wep != "VSS_vintorez" and _wep != "MP5SD" and _wep != "M4A1_AIM_SD_CAMO" and _wep != "M4A1_HWS_GL_SD_CAMO" and _wep != "G36_C_SD_Eotech" and _wep != "M9SD") exitwith
    {
	_UID = getPlayerUID player;
	if (_UID in CivSpawnShoot) exitWith {};
	deletevehicle _bullet;
    ...
    if(player distance nokill1 < 100 and _wep != "M1014" and _wep != "MakarovSD" and _wep != "VSS_vintorez" and _wep != "MP5SD" and _wep != "M4A1_AIM_SD_CAMO" and _wep != "M4A1_HWS_GL_SD_CAMO" and _wep != "G36_C_SD_Eotech" and _wep != "M9SD") exitwith
    {
	_UID = getPlayerUID player;
	if (_UID in NoKillShoot) exitWith {};
	deletevehicle _bullet;
	if(firestrikes == 0) exitwith
        {
            (format['hint "%1: YOU HAVE BEEN SENT TO JAIL FOR FIRING EXCESSIVELY IN A RESTRICTED AREA!";', name player]) call broadcast;
	...
	firestrikes = firestrikes - 1;
	(format['hint "WARNING %1: DO NOT FIRE NEAR NO KILL ZONE1 CIV SHOP AREA! %2/%3 chances left.";', name player, firestrikes, totalstrikes]) call broadcast;
    };
    if(player distance nokill2 < 75 and _wep != "M1014" and _wep != "MakarovSD" and _wep != "VSS_vintorez" and _wep != "MP5SD" and _wep != "M4A1_AIM_SD_CAMO" and _wep != "M4A1_HWS_GL_SD_CAMO" and _wep != "G36_C_SD_Eotech" and _wep != "M9SD") exitwith
    {
	_UID = getPlayerUID player;
	if (_UID in NoKillShoot) exitWith {};
	deletevehicle _bullet;
	...
	firestrikes = firestrikes - 1;
	(format['hint "WARNING %1: DO NOT FIRE NEAR NO KILL ZONE2 CAR SHOP! %2/%3 chances left.";', name player, firestrikes, totalstrikes]) call broadcast;
    };
    if(player distance nokill3 < 100 and _wep != "M1014" and _wep != "MakarovSD" and _wep != "VSS_vintorez" and _wep != "MP5SD" and _wep != "M4A1_AIM_SD_CAMO" and _wep != "M4A1_HWS_GL_SD_CAMO" and _wep != "G36_C_SD_Eotech" and _wep != "M9SD") exitwith
    {
	_UID = getPlayerUID player;
	if (_UID in NoKillShoot) exitWith {};
	deletevehicle _bullet;
	...
	firestrikes = firestrikes - 1;
	(format['hint "WARNING %1: DO NOT FIRE NEAR NO KILL ZONE3 Jail! %2/%3 chances left.";', name player, firestrikes, totalstrikes]) call broadcast;
    };
