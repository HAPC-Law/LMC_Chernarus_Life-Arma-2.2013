class schluessel
{
    ...
    class dummybutton : RscDummy {idc = 1013;};
};
...
class handydialog
{
    ...
    objects[] = { };
    controls[] = {eingabefeld, kosten, submit, cancel, spielerliste, dummybutton};
    ...
    class dummybutton : RscDummy {idc = 1016;};
};
...
class timebombconfig
{
    ...
    class dummybutton : RscDummy {idc = 1011;};
};
...
class speedbombconfig
{
    ...
    controlsBackground[] = {DLG_BACK1, background};
    objects[] = { };
    controls[] = {slider, text, wert, slider2, text2, wert2, submit, cancel, dummybutton};
    class DLG_BACK1: RscBackground
    {
        x = 0.04; y = 0.29;
        w = 0.91; h = 0.19;
    ...
    class dummybutton : RscDummy {idc = 1010;};
};
...
class remotebomb_remote
{
    ...
    class submit : RscButton
    {
        ...
        w = 0.10; h = 0.04;
        text = "Execute";
        action = "[""config"", ""activate"", ""fernzuenderbombe"", (ctrlText 1)] execVM ""bombs.sqf"";";
    };
    class cancel : RscButton
    {
        idc = 5;
    ...
    class dummybutton : RscDummy {idc = 1090;};
};
...
class hideout
{
    ...
    controlsBackground[] = {DLG_BACK1, background};
    objects[] = { };
    controls[] = {hideoutbild, hideoutliste, submit, cancel, dummybutton};
    class DLG_BACK1: RscBackground
    {
        x = 0.27; y = 0.09;
        w = 0.49; h = 0.39;
    ...
    class background : RscBgRahmen
    {
        x = 0.27; y = 0.09;
        w = 0.49; h = 0.39;
        text = $STRD_description_hideout_submit;
    };
    class hideoutbild : RscPicture
    {
        idc = 1;
        x = 0.53; y = 0.12;
        w = 0.22; h = 0.28;
    };
    class hideoutliste : RscListBox
    {
        idc = 2;
        x = 0.28; y = 0.12;
        w = 0.24; h = 0.27;
    ...
    class submit : RscButton
    {
        ...
        w = 0.20; h = 0.04;
        text = $STRD_description_hideout_submit;
        action = "[""action"",lbCurSel 2] execVM ""hideout.sqf""; closedialog 0;";
    };
    class cancel : RscButton
    {
        idc = 4;
    ...
    class dummybutton : RscDummy {idc = 1014;};
};