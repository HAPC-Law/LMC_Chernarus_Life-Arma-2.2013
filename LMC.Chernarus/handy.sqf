...
if (_FuckOffMoneyHackers < INV_smscost)  exitWith {player groupChat localize "STRS_inv_item_handy_keingeld";};														
if ((_smstext call ISSE_str_Length) > 60)     exitWith {player groupChat localize "STRS_inv_item_handy_text_zu_lang";};	
['moneyHackerFuckOff', -(INV_smscost)] call INV_AddInventoryItem;		
