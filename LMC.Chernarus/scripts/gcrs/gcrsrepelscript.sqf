...
if (_vehclass == "MH60S") then 
	{
	player setpos [(getpos vehicle player select 0) - 1.25, (getpos vehicle player select 1) + 2, (getpos vehicle player select 2) - 4];
	};
	
if (_vehclass == "UH1Y") then 
	{
	player setpos [(getpos vehicle player select 0) - 1.25, (getpos vehicle player select 1) - 3, (getpos vehicle player select 2) - 4];
	};
	
if (_vehclass == "MV22") then 
	{
	player setpos [(getpos vehicle player select 0), (getpos vehicle player select 1) - 6, (getpos vehicle player select 2) - 4];
	};
	
if ((_vehclass == "Mi17_Civilian") || (_vehclass == "Mi17_Ins") || (_vehclass == "Mi17_CDF") || (_vehclass == "Mi17_RU") || (_vehclass == "Mi17_rockets_RU")) then 
	{
	player setpos [(getpos vehicle player select 0) - 1.5, (getpos vehicle player select 1) + 5.5, (getpos vehicle player select 2) - 4];
	};
	
if ((_vehclass == "Mi24_D") || (_vehclass == "Mi24_P") || (_vehclass == "Mi24_V")) then 
	{
	player setpos [(getpos vehicle player select 0) - 1, (getpos vehicle player select 1) + 4, (getpos vehicle player select 2) - 4];
	};
...
if (_vehclass == "MV22") then 
	{
	player setposasl [_xpos, _ypos - 6, _endingheight];
	};
	
if ((_vehclass == "Mi17_Civilian") || (_vehclass == "Mi17_Ins") || (_vehclass == "Mi17_CDF") || (_vehclass == "Mi17_RU") || (_vehclass == "Mi17_rockets_RU")) then 
	{
	player setposasl [_xpos - 1.5, _ypos + 5.5, _endingheight];
	};
	
if ((_vehclass == "Mi24_D") || (_vehclass == "Mi24_P") || (_vehclass == "Mi24_V")) then 
	{
	player setposasl [_xpos - 1, _ypos + 4, _endingheight];
	};
...
if (leader group player == player) then
	...
	if (!(isplayer _x) && (alive _x) && (vehicle _x == _veh)) then
		...
		if (_vehclass == "MV22") then 
			{
			_x setpos [(getpos vehicle _x select 0), (getpos vehicle _x select 1) - 6, (getpos vehicle _x select 2) - 4];
			};
			
		if ((_vehclass == "Mi17_Civilian") || (_vehclass == "Mi17_Ins") || (_vehclass == "Mi17_CDF") || (_vehclass == "Mi17_RU") || (_vehclass == "Mi17_rockets_RU")) then 
			{
			_x setpos [(getpos vehicle _x select 0) - 1.5, (getpos vehicle _x select 1) + 5.5, (getpos vehicle _x select 2) - 4];
			};
			
		if ((_vehclass == "Mi24_D") || (_vehclass == "Mi24_P") || (_vehclass == "Mi24_V")) then 
			{
			_x setpos [(getpos vehicle _x select 0) - 1, (getpos vehicle _x select 1) + 4, (getpos vehicle _x select 2) - 4];
			};
		...
		if (_vehclass == "MV22") then 
			{
			_x setposasl [_xpos, _ypos - 6, _endingheight];
			};
			
		if ((_vehclass == "Mi17_Civilian") || (_vehclass == "Mi17_Ins") || (_vehclass == "Mi17_CDF") || (_vehclass == "Mi17_RU") || (_vehclass == "Mi17_rockets_RU")) then 
			{
			_x setposasl [_xpos - 1.5, _ypos + 5.5, _endingheight];
			};
			
		if ((_vehclass == "Mi24_D") || (_vehclass == "Mi24_P") || (_vehclass == "Mi24_V")) then 
			{
			_x setposasl [_xpos - 1, _ypos + 4, _endingheight];
			};
