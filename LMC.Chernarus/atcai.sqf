if (('moneyHackerFuckOff' call INV_GetItemAmount) < 2000000) exitWith {player groupChat "You Need 2 Million Dollars For This.";};
['moneyHackerFuckOff', -2000000] call INV_addinventoryitem;
