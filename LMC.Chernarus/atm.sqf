...
CtrlSetText [101, format [localize "STRS_bank_dialog_inventargeld", (_FuckOffMoneyHackers call ISSE_str_IntToStr)]];
CtrlSetText [102, format [localize "STRS_bank_dialoge_accountgeld",  (leavemybankmoneyalone call ISSE_str_IntToStr)]];
