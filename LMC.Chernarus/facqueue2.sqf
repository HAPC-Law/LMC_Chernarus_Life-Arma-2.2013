if(typename _this == "ARRAY") exitwith
	...
	if(_FuckOffMoneyHackers < (facworkercost2*10) )exitwith{player groupchat "you do not have enough money"};
	
	["moneyHackerFuckOff", -(facworkercost2*10)] call INV_addinventoryitem;
