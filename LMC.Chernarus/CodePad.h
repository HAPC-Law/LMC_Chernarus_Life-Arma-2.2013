...
class RUG_CodePad
{
    ...
    class digit7 : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.02;
        text = "7";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),7];ctrlSetText [999,num];playsound ""button7""";
        default = false;
    };
    class digit8 : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.020;
        text = "8";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),8];ctrlSetText [999,num];playsound ""button8""";
        default = false;
    };
    class digit9 : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.020;
        text = "9";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),9];ctrlSetText [999,num];playsound ""button9""";
        default = false;
    };
    class digit4 : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.020;
        text = "4";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),4];ctrlSetText [999,num];playsound ""button4""";
        default = false;
    };
    class digit5 : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.020;
        text = "5";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),5];ctrlSetText [999,num];playsound ""button5""";
        default = false;
    };
    class digit6 : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.020;
        text = "6";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),6];ctrlSetText [999,num];playsound ""button6""";
        default = false;
    };
    ...
    class digit2 : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.020;
        text = "2";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),2];ctrlSetText [999,num];playsound ""button2""";
        default = false;
    };
    class digit3 : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.020;
        text = "3";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),3];ctrlSetText [999,num];playsound ""button3""";
        default = false;
    };
    class digit0 : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.020;
        text = "0";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),0];ctrlSetText [999,num];playsound ""button0""";
        default = false;
    };
    class digit_X : RUG_CodePad_RscButton
    {
        ...
        SizeEX = 0.020;
        text = "*";
        action = "Keypad_num = Keypad_num +1;num=format [""%1%2"",(ctrlText 999),""*""];ctrlSetText [999,num];playsound ""buttonstar""";
        default = false;
    };
