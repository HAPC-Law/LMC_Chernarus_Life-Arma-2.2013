...
class balca_sound_player
{
    ...
    controlsBackground[] = {balca_debug_background};
    objects[] = {};
    controls[] = {balca_soundlist,balca_clipboard_btn,balca_close_btn};
    /////////////////
    class balca_debug_background
    {
        idc = -1;
...
class balca_statistics
{
    ...
    controlsBackground[] = {balca_debug_background};
    objects[] = {};
    controls[] = {balca_stat_text,balca_reset_btn,balca_clipboard_btn,balca_close_btn};
    /////////////////
    class balca_debug_background
    {
        idc = -1;
...
class balca_environment
{
    ...
    controlsBackground[] = {balca_debug_background};
    objects[] = {};
    controls[] = {balca_env_control_group,balca_apply_btn};
    /////////////////
    class balca_debug_background
    {
        idc = -1;
