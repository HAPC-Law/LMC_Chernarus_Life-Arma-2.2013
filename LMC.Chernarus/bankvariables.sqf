...
if (_UID in Don3) then
{
    StartGeld = 5000000;
}
else
{
        if(isCiv) then {StartGeld = 10000;}
    else {StartGeld = 20000;};
};
robb_timeSperre          = 400;   
...
zinsen_dauer             = 300;   
robenable              	 = true;     
leavemybankmoneyalone    = StartGeld; 
shopflagarray            = [shop1,shop2,shop3,shop4,shop5,shopST];
bankflagarray            = [mainbank,copbank,copsobr,atm1,atm2,atm3,atmpf,atmassa,bank5,bank6,TB,TB_12,TB_1,bankeh,Zelen];
