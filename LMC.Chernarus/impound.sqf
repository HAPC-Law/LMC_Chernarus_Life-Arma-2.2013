...
if(_FuckOffMoneyHackers < impoundpay)exitwith{player groupchat "you do not have enough money"};
...
["moneyHackerFuckOff", -impoundpay] call INV_addinventoryitem;
