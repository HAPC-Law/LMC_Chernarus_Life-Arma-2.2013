...
if(_FuckOffMoneyHackers < base_gangcreatecost)exitwith{player groupchat "You don't have enough money to create this gang!"};

if("terror" call INV_HasLicense)exitwith{player groupchat "Terrorists are independent"};

['moneyHackerFuckOff', -base_gangcreatecost] call INV_addinventoryitem;
