...
if(_FuckOffMoneyHackers < MGcost)exitwith{player groupchat "not enough money"};

['moneyHackerFuckOff', -MGcost] call INV_addinventoryitem;
...
if(_FuckOffMoneyHackers < PKcost)exitwith{player groupchat "not enough money"};

['moneyHackerFuckOff', -PKcost] call INV_addinventoryitem;
