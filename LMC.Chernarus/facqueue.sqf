if(typename _this == "ARRAY") exitwith
	...
	if(_FuckOffMoneyHackers < facworkercost)exitwith{player groupchat "you do not have enough money"};
	
	["moneyHackerFuckOff", -facworkercost] call INV_addinventoryitem;
